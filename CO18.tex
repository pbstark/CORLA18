...
We have observed (but not proven) that given $N$, $c$, and the observed sample values $B_w$ and $B_\ell$, $p_c$ has a unique maximum where $A_{w,s}$ is either as small or as large as possible.
