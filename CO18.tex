...
In 87\% of 10,000 simulations in which
the reported results were correct, drawing 500~ballots from the CVR stratum and 700~ballots 
from the no-CVR stratum (1,200 ballots in all)
allowed SUITE to confirm the outcome at 10\% risk.
For the remaining 13\%, further expansion of the audits would have been necessary.
