...
hypothesis at level $\alpha$, the audit can stop, i.e., if the minimum value Fisher's combined statistic over all $\lambda$ is larger than the $1-\alpha$ quantile of the chi-square
