...
most efficient approach to risk-limiting audits in that they require examining the fewest
...
California to be rather less efficient than ballot-polling audits.%
\footnote{%
...
Calculating $p_s(\lambda)$ is described in
section~\ref{sec:comparisonError} for a CVR stratum and in~\ref{sec:ballotPollError}
for a no-CVR stratum.
