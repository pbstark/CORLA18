...
or supplemented % ML: I want to signal that we needn't remake the architecture in June
...
% ML style note: the manuals I use deprecate a comma between Month and YYYY.
\end{abstract}
...
%  ML: We know that legacy counties have a paper trail, and they've already been
%        audited by ballot-polling. Let's not swerve into generality here.
...
% ML: this really seems to belabor the obvious, which can backfire by encouraging the
%       reader to look for non-existent nuances. 
