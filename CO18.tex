...
While in reality, $c(\lambda)$ and $N_w(\lambda)$ must be integer values
(as they represent numbers of ballots),
the $P$-value from the ballot-polling SPRT and thus $\chi(\lambda)$ will be continuous by allowing
$c(\lambda)$ and $N_w(\lambda)$ to be continuous.
