...
$110,00$ votes and a diluted margin of $1.8\%$.
For the parameters we chose, if the audit in the CVR stratum found no errors, 
it would terminate after examining 327 ballots.
In X\% of 10,000 simulations, an audit of Y ballots from the no-CVR stratum
would have sufficed to confirm that the overstatement error in that stratum
did not exceed its allocation, Z\% of the margin.
...
For the parameters we chose, the CVR stratum would examine ??~ballots if no discrepancies
were found. 
In X\% of 10,000 simulations, an audit of Y ballots from the no-CVR stratum
would have sufficed to confirm that the overstatement error in that stratum
did not exceed its allocation, Z\% of the margin.
