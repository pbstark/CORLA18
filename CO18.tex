...
In practice, it is not necessary to consider all possible partitions the allowable error across strata: the $P$-value is a difference of monotonic functions, which allows us to find upper and lower bounds everywhere from the values on a discrete grid.
