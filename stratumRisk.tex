...
hand tabulation. 
\note{flesh out the argument without relying on sequential nature of the test: should hold purely
on the basis of the unconditional test having the right level, and the samples being independent in 
the two strata}
