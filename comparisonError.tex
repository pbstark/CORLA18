...
\begin{itemize}
    ...
    \item  $P$ ``batches'' of ballots are in the stratum. A batch contains one or more ballots. Every ballot in the stratum is in exactly one batch.
...
One particularly ``clean'' sequential method is based on Wald's~\cite{wald45} Sequential Probability
Ratio Test (SPRT).
